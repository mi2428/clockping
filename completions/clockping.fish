...
function __fish_clockping_global_optspecs
	string join \n ts.preset= ts.format= out.format= out.colored push.url= push.delete-on-exit push.interval= push.job= push.label= push.retries= push.timeout= push.user-agent= metrics.file= metrics.format= metrics.label= metrics.prefix= h/help V/version
end
...
complete -c clockping -n "__fish_clockping_needs_command" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_needs_command" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_needs_command" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_needs_command" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand icmp" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand icmp" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand icmp" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand icmp" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand icmp" -s V -l version -d 'Print version'
...
complete -c clockping -n "__fish_clockping_using_subcommand tcp" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand tcp" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand tcp" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand tcp" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand tcp" -s V -l version -d 'Print version'
...
complete -c clockping -n "__fish_clockping_using_subcommand http" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand http" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand http" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand http" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand http" -s V -l version -d 'Print version'
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and not __fish_seen_subcommand_from v1u v1c v2c help" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and not __fish_seen_subcommand_from v1u v1c v2c help" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and not __fish_seen_subcommand_from v1u v1c v2c help" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and not __fish_seen_subcommand_from v1u v1c v2c help" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and not __fish_seen_subcommand_from v1u v1c v2c help" -s V -l version -d 'Print version'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1u" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1u" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1u" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1u" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1u" -s V -l version -d 'Print version'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1c" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1c" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1c" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1c" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v1c" -s V -l version -d 'Print version'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v2c" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v2c" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v2c" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v2c" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand gtp; and __fish_seen_subcommand_from v2c" -s V -l version -d 'Print version'
...
complete -c clockping -n "__fish_clockping_using_subcommand completion" -l ts.preset -d 'Timestamp preset for human-readable output' -r -f -a "local\t''
rfc3339\t''
unix\t''
unix-ms\t''
none\t''"
complete -c clockping -n "__fish_clockping_using_subcommand completion" -l ts.format -d 'strftime-like timestamp format, similar to `date +"..."`' -r
complete -c clockping -n "__fish_clockping_using_subcommand completion" -l out.format -d 'Output format' -r -f -a "text\t''
json\t''"
...
complete -c clockping -n "__fish_clockping_using_subcommand completion" -l out.colored -d 'Colorize human-readable output with ANSI escape sequences'
...
complete -c clockping -n "__fish_clockping_using_subcommand completion" -s V -l version -d 'Print version'
